...
Route::get('deleteList/{id}', [App\Http\Controllers\ItemController::class, 'deleteList']);
...
//test
//Route::get('viewlist',[ShoppingListController::class, 'getList']);
//Route::get('viewlist',[ShoppingListController::class, 'index']);
